<?php
  ...
  //define(PRIJEMCE, 'ascm00@vse.cz');//TODO tady zadejte vlastní e-mailovou adresu
  ...
  $mailer->addAddress('ascm00@vse.cz');
  $mailer->setFrom('ascm00@vse.cz');
  $mailer->addCC('stanislav.vojir@vse.cz');
